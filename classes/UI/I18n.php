...
class I18n {
  private const STRINGS = [
    'de' => [
      ...
      'site.lag'           => 'Erzeugung und Lastflüsse kommen von der ENTSO-E-Transparenzplattform und sind etwa eine halbe Stunde alt; einzelne Grenzen folgen später. Der Day-Ahead-Preis kommt von SMARD. Die amtliche CO₂-Intensität folgt erst einige Stunden später — bis dahin wird sie aus dem Erzeugungsmix berechnet und anschließend durch den amtlichen Wert ersetzt.',
    ...
    'en' => [
      ...
      'site.lag'           => 'Generation and flows come from the ENTSO-E Transparency Platform and are around half an hour old; some borders follow later. The day-ahead price comes from SMARD. The official carbon intensity follows a few hours later — until it arrives it is calculated from the generation mix, then replaced by the official figure.',
