...
?>
      <section>
        ...
        <p>
          If you’d like to thank me for the time I’ve spent working on this project, or help me cover the costs of hosting a site that received <?= number_format($state->visits) ?> visits over the past year, <a href="https://ko-fi.com/katemorley">I do accept donations</a>.
        </p>
        <?php (new Graphs($state))->output(Graph::Visits, Period::Year); ?>
        <p>
