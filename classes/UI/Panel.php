...
<?php Tables::output($average->sources); ?>
          ...
          <div>
            <h3>Price per MWh</h3>
            <?php Graph::Price->output($series, $axes, $timeStep, $timeFormat); ?>
          </div>
          <div>
            <h3>Emissions per kWh</h3>
            <?php Graph::Emissions->output($series, $axes, $timeStep, $timeFormat); ?>
          </div>
          <div>
            <h3>Demand</h3>
            <?php Graph::Demand->output($series, $axes, $timeStep, $timeFormat); ?>
          </div>
          <div>
            <h3>Generation</h3>
            <?php Graph::Generation->output($series, $axes, $timeStep, $timeFormat); ?>
          </div>
          <div>
            <h3>Transfers</h3>
            <?php Graph::Transfers->output($series, $axes, $timeStep, $timeFormat); ?>
          </div>
<?php
  }
}
