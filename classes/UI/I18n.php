...
class I18n {
  private const STRINGS = [
    'de' => [
      ...
      'site.lag'           => 'Erzeugung, Lastflüsse und Preis kommen von SMARD und sind rund eine Stunde alt. Die amtliche CO₂-Intensität folgt erst einige Stunden später — bis dahin wird sie aus dem Erzeugungsmix berechnet und anschließend durch den amtlichen Wert ersetzt.',
    ...
    'en' => [
      ...
      'site.lag'           => 'Generation, flows and price come from SMARD and are around an hour old. The official carbon intensity follows a few hours later — until it arrives it is calculated from the generation mix, then replaced by the official figure.',
